...
class DepositHistoryController extends Controller
{
    ...
    public function getTodayCollection(Request $request)
    {
        ...
        try{
            $collection = $this->depositHistoryRepository->getTodayCollection($request->member_id);
            ...
            else
            {
                ...
                if(count($loanIds) > 1){
                    ...
                    $totalAttendedCustomer = $this->customerDepositRepository->getTotalAttendedCustomer($loanIds);
                }

                $totalCustomer = $this->customerDepositRepository->getTotalCustomers($request->member_id,'paid');
                $responseData = 
                [
